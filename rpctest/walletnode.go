...
// walletTestConfig contains all the args, and data required to launch a hcashwallet process
...
// command returns the exec.Cmd which will be used to start the hcashwallet
// process.
...
// to connect to the hcashwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for hcashwallet.
...
// Start creates a new hcashwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running hcashwalletTest process process, and waits until it exits
