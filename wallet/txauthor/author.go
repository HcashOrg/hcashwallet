...
// InputSourceError.
type InputSource func(target hcashutil.Amount) (total hcashutil.Amount,
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb hcashutil.Amount,
