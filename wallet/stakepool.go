...
func (w *Wallet) StakePoolUserInfo(userAddress hcashutil.Address) (*udb.StakePoolUser, error) {
	switch userAddress.(type) {
	case *hcashutil.AddressPubKeyHash: // ok
	case *hcashutil.AddressScriptHash: // ok
	default:
