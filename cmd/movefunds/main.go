...
type configJSON struct {
	...
	DcrctlArgs    string `json:"hcashctlargs"`
}
...
func convertJSONUnspentToOutPoints(
	utxos []hcashjson.ListUnspentResult) []*extendedOutPoint {
	...
	for _, utxo := range utxos {
		...
		eop.op = op
		amtCast, _ := hcashutil.NewAmount(utxo.Amount)
...
func main() {
	...
	var utxos []hcashjson.ListUnspentResult
	...
	sendToAddress, err := hcashutil.DecodeAddress(cfg.SendToAddress)
	if err != nil {
