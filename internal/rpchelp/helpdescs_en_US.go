...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in hypercash",
	"getbalance--result1":    "The balance of all accounts valued in hypercash",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in hypercash",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in hypercash",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in hypercash",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and hypercash amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in hypercash",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in hypercash",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in hypercash",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in hypercash",
	...
	"listunspentresult-amount":        "The amount of the output valued in hypercash",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in hypercash",
	...
	"setticketmaxprice-max":       "The max price (in hcash).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in hypercash",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in hypercash.",
	...
	"getwalletfee--result0":  "Current tx fee (in HCASH)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in hypercash",
