...
import (
	...
	_ "github.com/HcashOrg/hcashwallet/walletdb/bdb" // driver loaded during init
)
...
type Loader struct {
	...
	chainClient *hcashrpcclient.Client
...
func (l *Loader) SetChainClient(chainClient *hcashrpcclient.Client) {
	l.mu.Lock()
